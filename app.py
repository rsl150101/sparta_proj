...
def profile(user_id):
    ...
    if result[3] is not None:
        ...
        data_url = '1'
    return render_template('profile.html', userId=user_id, username=user_name, userEmail=user_email, image_url=data_url, pageTitle=page_title)
...
def edit_profile(user_id):
    ...
    return render_template('edit-profile.html', userId=user_id, username=user_name, userEmail=user_email, image_url=data_url, pageTitle=page_title)
...
def update_profile(user_id):
    ...
    return render_template('edit-profile.html', userId=user_id, username=user_name, image_url=data_url, userEmail=user_email)
